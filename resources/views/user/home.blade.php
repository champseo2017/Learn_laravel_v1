...
@section("title") หน้าแรก | เว็บแนะนำโปรโมชั่นสินค้ามากมาย @endsection
...
<section class="home-banner-area relative">
		...
		<div class="rocket-img">
			<img src="{{ asset('user/img/rocket.png') }}" alt="">
		</div>
	</section>
	<!-- End Banner Area -->
		...
		<div class="container">
			<div class="row align-items-center justify-content-center">
				<div class="col-lg-5 col-md-6 about-left">
					<img class="img-fluid" src="{{ asset('user/img/about.jpg') }}" alt="">
				</div>
			...
			<div class="row justify-content-center d-flex align-items-center">
				<div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
					<div class="thumb d-flex justify-content-center">
						<img class="img-fluid" src="{{ asset('user/img/faculty/f1.jpg') }}" alt="">
					</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
					<div class="thumb d-flex justify-content-center">
						<img class="img-fluid" src="{{ asset('user/img/faculty/f2.jpg') }}" alt="">
					</div>
					<div class="meta-text text-center">
						<h4>Rodney Cooper</h4>
						<p class="designation">Sr. Faculty Data Science</p>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
					<div class="thumb d-flex justify-content-center">
						<img class="img-fluid" src="{{ asset('user/img/faculty/f3.jpg') }}" alt="">
					</div>
					<div class="meta-text text-center">
						<h4>Dora Walker</h4>
						<p class="designation">Sr. Faculty Data Science</p>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
					<div class="thumb d-flex justify-content-center">
						<img class="img-fluid" src="{{ asset('user/img/faculty/f4.jpg') }}" alt="">
					</div>
					<div class="meta-text text-center">
						<h4>Lena Keller</h4>
						<p class="designation">Sr. Faculty Data Science</p>
		...
		<div class="container">
			<div class="testi-slider owl-carousel" data-slider-id="1">
				<div class="item">
					<div class="testi-item">
						<img src="{{ asset('user/img/quote.png') }}" alt="">
						<h4>Fanny Spencer</h4>
						<ul class="list">
			...
			<div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid" src="{{ asset('user/img/testimonial/t1.jpg') }}" alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid" src="{{ asset('user/img/testimonial/t2.jpg') }}" alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid" src="{{ asset('user/img/testimonial/t3.jpg') }}" alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid" src="{{ asset('user/img/testimonial/t4.jpg') }}" alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
			</div>
